 ...
 * @Description: 记一笔的支出页面
 */
public class IndexRecordOutFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_index_record_out, container, false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        textMoney = activity.findViewById(R.id.fragment_index_record_out_money_text);
        textRemark = activity.findViewById(R.id.fragment_index_record_out_remark_text);
        dateLayout = activity.findViewById(R.id.fragment_index_record_out_date);
        ...
        //设置图标list的适配器
        RecyclerView categoryImageRecyclerView = activity.findViewById(R.id.fragment_index_record_out_add_image_recyclerView);
