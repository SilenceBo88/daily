 ...
 * @Description: 修改记录的支出页面
 */
@SuppressLint("ValidFragment")
public class IndexRecordUpdateOutFragment extends Fragment {
    ...
    public IndexRecordUpdateOutFragment(Record record){
        this.record = record;
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_index_record_update_out, container, false);
        return view;
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        textMoney = activity.findViewById(R.id.fragment_index_record_update_out_money_text);
        textRemark = activity.findViewById(R.id.fragment_index_record_update_out_remark_text);
        dateLayout = activity.findViewById(R.id.fragment_index_record_update_out_date);
        dateText = activity.findViewById(R.id.fragment_index_record_update_out_date_text);
        assetsLayout = activity.findViewById(R.id.fragment_index_record_update_out_assets);
        assetsText = activity.findViewById(R.id.fragment_index_record_update_out_assets_text);
        categoryImage = activity.findViewById(R.id.fragment_index_record_update_out_category_image);
        saveButton = activity.findViewById(R.id.fragment_index_record_update_out_btn_save);

        assetsList = assetsDao.findAssetsList();
        listAdapter = new AssetsTransferDialogAdapter(MyApplication.getContext(), assetsList);
        categoryImageList = categoryDao.findCategoryListByType(1);
        ...
        //设置图标list的适配器
        RecyclerView categoryImageRecyclerView = activity.findViewById(R.id.fragment_index_record_update_out_add_image_recyclerView);
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Record temp = new Record(Double.valueOf(money), defaultDate, remark, 1,
